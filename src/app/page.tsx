            ...
            <main className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="mb-10">
                    ...
                    <p className="text-gray-600">
                        View all organizations and total users.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {orgs.length > 0 ? (
                        orgs.map((org) => (
                            <div
                                key={org.id}
                                className="relative overflow-hidden rounded-2xl p-6 border border-white/30 bg-white/40 backdrop-blur-xl shadow-lg"
                            >
                                <div
